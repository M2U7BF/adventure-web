import { SCREEN_WIDTH, SCREEN_HEIGHT, TILE_DEFS, OBJECT_DEFS, RANDOM_OBJECT_TYPES, FIXED_OBJECT_PLACEMENTS, DEFAULT_PLAYER_TILE, PLAYER_SPRITE_SRC, SFX_SRC, GRASS_TILE, MAX_WORLD_COL, MAX_WORLD_ROW, DIFFICULTIES, DEFAULT_DIFFICULTY, HIDDEN_ITEM_COUNT, BEST_TIME_STORAGE_KEY } from "./constants.js";
...
// Builds the map, world objects, hidden collectibles and enemies for the
// chosen difficulty, and applies its player speed bonus. Runs synchronously
// since every image is already loaded by loadAssets().
function setupWorld(difficultyKey) {
  ...
  state.mapTileNum = generateMap(allPlacements, DEFAULT_PLAYER_TILE, difficulty.obstacleDensity);
  state.worldObjects = [
